const SOTIMA_ICONS_MAP = {
  ...
  "window-shutter-group": "m12 8.0176v-2.018h-8v9h-1.268v-9h-0.732v-2h12v2h-0.768v2.018zm-3 4.982v2h-4v-2zm-1-3v2h-3v-2zm3-1.982h-3v0.982h-3v-2h6zm-1.9911 0.96033h12.991v2h-1v9h-1.5v-9h-7.5v9h-1.5v-9h-1v-2m2.5089 3h6.4911v2h-5.5v-2m-0.99111 3h6.4911v2h-5.5v-2m-0.99111 3h6.4911v2h-5.5v-2",
	"window-shutter-group-partly": "m12 8.0176v-2.018h-8v9h-1.268v-9h-0.732v-2h12v2h-0.768v2.018zm-4 0.98243v2h-3v-2zm3-0.99121c-1.9829 0.0037677-4.1894-0.0093371-6-0.0087865v-1.0004h6zm11 0.96912v2h-1v9h-1.5v-9h-7.5v9h-1.5v-9h-1v-2m2.5089 3h6.4911v1.0221h-5.5v-1.0221m0 2.0221h5.5v2h-5.5v-2",
...
console.info(
  `%c HASS-SOTIMA-ICONS         \n%c Version 1.5 [` + sotima_icons_mode + `] `,
