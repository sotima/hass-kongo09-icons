const SOTIMA_ICONS_MAP = {
  ...
  "window-shutter-group": "m13.018 8v-2.018h-8v9h-1v-9h-1v-2h12v2h-1v2.018zm-4.018 4.982v2h-2.982v-2zm-1-3v2h-1.982v-2zm4.018-1.982h-4.018v0.982h-1.982v-2h6zm-3.0091 1h12v2h-1v9h-1v-9h-8v9h-1v-9h-1v-2m3 3h6v2h-6v-2m0 3h6v2h-6v-2m0 3h6v2h-6v-2",
	"window-shutter-group-partly": "m13.018 8v-2.018h-8v9h-1v-9h-1v-2h12v2h-1v2.018zm-5.018 1v2h-1.982v-2zm4.018-1h-6v-1.018h6zm-3.0091 1h12v2h-1v9h-1v-9h-8v9h-1v-9h-1v-2m3 3h6v1h-6v-1m0 2h6v2h-6v-2",
	"window-shutter-group-open": "m13.018 8v-2.018h-8v9h-1v-9h-1v-2h12v2h-1v2.018zm-1 0h-6v-1.018h6zm-3.0091 1h12v2h-1v9h-1v-9h-8v9h-1v-9h-1v-2m3 3h6v1h-6v-1",
...
console.info(
  `%c HASS-SOTIMA-ICONS         \n%c Version 1.4 [` + sotima_icons_mode + `] `,
